...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { name: "description", content: "age calculator based on birth date" },
  ];
}
interface Age {
  years: number;
...
export default function Home() {
  ...
  return (
    ...
    <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center">
      ...
      <input
        type="date"
        className="w-full p-3 border rounded-lg shadow-sm mb-4 text-black focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
        value={dob}
      ...
      {age && (
        <div className="mt-6 p-4 bg-gray-100 rounded-lg shadow-md flex gap-2 justify-center">
          ...
          <p className="text-lg  text-gray-900">{age.years} Years Old</p>
        </div>
      )}
    </div>
  </div>
